# 🎸 Tone Library — Phase 1 Build Instructions
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        {tone.favorite && (
          <Star size={14} className="text-brand-accent fill-brand-accent shrink-0 mt-1 ml-2" />
        )}
      </div>
...
const ALL_TAGS = ["metal", "clean", "ambient", "blues", "djent", "country", "rhythm", "lead", "crunch", "high-gain"];
...
const AVAILABLE_TAGS = ["metal", "clean", "ambient", "blues", "djent", "country", "rhythm", "lead", "crunch", "high-gain"];
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        {tone.favorite && (
          <Star size={18} className="text-brand-accent fill-brand-accent mt-1 ml-4 shrink-0" />
        )}
      </div>
